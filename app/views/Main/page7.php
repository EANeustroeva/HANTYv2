...
<div class="mb-3">
    <a class="btn btn-raised bg-purple mr-3" href="#" role="button" data-toggle="modal" data-target="#video"><i class="fa fa-link"></i> Добавить по ссылке</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div><a class="mb-3" href="?id=oJPNMOisyCw">https://www.youtube.com/watch?v=oJPNMOisyCw</a></div>
        <div><a class="mb-3" href="?id=OmApr4hAm1A">https://www.youtube.com/watch?v=OmApr4hAm1A</a></div>
      </div>
    </div>
  </div>
</div>
...
<a class="btn btn-raised btn-primary btn-sm mt-auto mb-3" href="?id=NFBmlewLt8w">video</a>
...
<?php foreach ($_SESSION['buttons'] as $button):?>
    <?php if (in_array($button,['NFBmlewLt8w'])) continue; ?>
